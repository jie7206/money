...
def create_different_currency_properties
  ...
  p1 = create(:property, amount: 11000.0, currency: currencies(:twd))
  p2 = create(:property, amount: 12000.0, currency: currencies(:cny))
  p3 = create(:property, amount: 13000.0, currency: currencies(:usd))
  p4 = create(:property, amount: -2000.0, currency: currencies(:twd), name: '台币贷款')
  p5 = create(:property, amount: -1000.0, currency: currencies(:cny), name: '人民币贷款')
  # 建立p4,p5的利息资料
...
def property_total_lixi_to( target_code )
  ...
  @ls.each do |l|
    ...
    result += (l.property.cal_lixi)*(to_ex/ex)
  end
